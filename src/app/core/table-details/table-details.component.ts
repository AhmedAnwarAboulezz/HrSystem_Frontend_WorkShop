...
export class TableDetailsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    if (this.columns.includes('view')) {
      ...
      this.containDelete = this.hasDelete && this.hasEditAndDelete && this.roles.canDelete;
      this.containEdit = this.hasEdit && this.hasEditAndDelete && this.roles.canUpdate;
      //this.containEdit =  this.roles.canUpdate && this.hasUpdate;
